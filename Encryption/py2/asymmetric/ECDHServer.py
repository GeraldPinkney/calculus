...
class ECDHServer:
    ...
    def submit_key(self, pk):
        ...
        print("The server's shared key is: ", self.shared_key.encode("string_escape"))
    ...
    def get_encrypted_message(self):
        ...
        ciphertext = encryptor.update(''.join([chr(ord(a) - 48 % 255) for a in message])) + encryptor.finalize()
